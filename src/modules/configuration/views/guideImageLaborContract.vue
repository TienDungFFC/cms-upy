<template>
    <configuration>
        <editor v-model="form.guide_image_labor_contract" :class="{ 'is-invalid': errors.guide_image_labor_contract }" />
...
export default {
    ...
    methods: {
        ...
        async save() {
            ...
            let form = this.form;
            let query = {};
            query.guide_image_labor_contract = form.guide_image_labor_contract;
